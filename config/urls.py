...
from config.url.api.kakao import KAKAO_API_URLS, KAKAO_PAY_API_URLS, KAKAO_OPTION_API_URLS
from config.url.api.slack import SLACK_API_URLS
from config.url.kakao_skill.user import KAKAO_SKILL_USER_URLS
...
urlpatterns += KAKAO_OPTION_API_URLS
