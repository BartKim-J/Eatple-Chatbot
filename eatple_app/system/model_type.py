...
# ORDER RECORD
ORDER_RECORD_GET_STORE = 0
ORDER_RECORD_GET_MENU = 1
ORDER_RECORD_SET_PICKUP_TIEM = 2
ORDER_RECORD_ORDERSHEET_CHECK = 3

ORDER_RECORD_PAYMENT_CONFIRM = 4
ORDER_RECORD_PAYMENT_COMPLETED = 5
ORDER_RECORD_PAYMENT_FAILED = 6
ORDER_RECORD_PAYMENT_CANCELED = 7

ORDER_RECORD_PICKUP_COMPLETED = 8
ORDER_RECORD_TIMEOUT = 10

ORDER_RECORD = [
    (ORDER_RECORD_GET_STORE, '상점보기'),
