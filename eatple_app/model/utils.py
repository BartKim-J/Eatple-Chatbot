...
class DefaultImage(models.Model):
    ...
    name = models.CharField(
        default="", max_length=STRING_LENGTH, help_text="subject name")

    filename = models.CharField(max_length=STRING_LENGTH, help_text="filename")
    image = models.ImageField(
        blank=False, upload_to=default_directory_path, storage=OverwriteStorage())
...
class UserManual(models.Model):
    ...
    filename = models.CharField(
        default="", max_length=STRING_LENGTH, help_text="filename")
    image = models.ImageField(
        blank=False, upload_to=default_directory_path, storage=OverwriteStorage())

    title = models.CharField(
        default="", max_length=STRING_LENGTH, help_text="Title", blank=True)
    description = models.TextField(
        default="", help_text="Description", blank=True)
