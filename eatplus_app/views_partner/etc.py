...
# # # # # # # # # # # # # # # # # # # # # # # # #
PARTNER_MANUAL_MAP = [
    {'title': "매장고유번호는 어디서 알 수 있나요?", 'description': "운영매뉴얼에 스티커로 부착되어 있습니다. 분실 시 상담원에게 문의해주세요."},
    {'title': "주문 조회는 어떻게 해야하나요?", 'description': "매일 점심/저녁 예약완료시간에 주문내역을 자동으로 보내드립니다."},
    {'title': "당일 정산 내역은 언제 보내주시나요?", 'description': "당일 정산내역은 매일 오후 9시에 자동으로 발송해드립니다."},
    {'title': "정산 조회는 어디서 할 수 있나요?", 'description': "정산 조회를 클릭하신 후 날짜를 선택해주시면 정산내역 확인이 가능합니다."},
...
PARTNER_INTRO_MAP = [
    ...
    {'title': "새로운 온라인 판매채널 확보", 'description': "포장 판매로 매장 크기, 회전율과 관계없이 추가 매출이 가능해집니다. 선불 결제시스템으로 노쇼로 인한 영업손실을 방지할 수 있습니다."},
    {'title': "잇플의 성공적인 파트너가 되어주세요!", 'description': "잇플은 점주님들과 함께 성장하기 위해 끊임없이 노력할 것입니다. 잇플과 함께 추가지출 없이 배로 뛰는 매출을 경험하세요."},
]
